-- Sidebar.lua
-- SynceHub - Sidebar untuk Potato Idle (tanpa pill)
...
function Sidebar.create(g, m, Co, onTabSwitch)
    ...
    -- ============================================
    -- SYNC POSISI SIDEBAR KE MAIN FRAME
    -- ============================================
    local function syncPositions()
        ...
        sidebar.Position = UDim2.new(0, mX - SB_W - SB_GAP, 0, mY + SB_Y_OFFSET)
        sidebar.Size     = UDim2.new(0, SB_W, 0, mH - SB_Y_OFFSET * 2)
    end

    -- Sync otomatis saat m visible berubah
    ...
    return {
        ...
        -- Stub biar tidak error kalau masih dipanggil dari Lop.lua
