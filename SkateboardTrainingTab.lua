...
local function showConfirmDialog()
    ...
    homeTitle.Text = "SynceHub - Skateboard Training"
    ...
    homeDesc.Text = "Welcome to SynceHub for Skateboard Training!\n\nFeatures:\n• Ticket Lucky Wheel Farm\n• OP Auto Train\n• Custom Spin Amount\n• Auto Spin"
    ...
    Tg("Ticket Lucky Wheel", "TicketLuckyWheel", function(val)
        Feature.toggleTicketLuckyWheel(val)
    end, "140507950554297")
    ...
    Ib("Spin Amount", "SpinAmount")
    
    Tg("Auto Spin", "AutoSpin", function(val)
        Feature.toggleAutoSpin(val)
    end, "140507950554297")
