...
function TabContent.createUI(config, state, version, isMobile, featureModule, getKeyName, gameName, themesModule)
    ...
    neonPurpleGrad.Color = ColorSequence.new{
        ...
        ColorSequenceKeypoint.new(0.5, Color3.fromRGB(90, 30, 160)),
    ...
    local function applyTheme(theme)
        ...
        if theme.ID == "neon_purple" then
            ...
            grad.Color = ColorSequence.new{
                ColorSequenceKeypoint.new(0,   Color3.fromRGB(40, 10, 80)),   -- ungu tua
                ColorSequenceKeypoint.new(0.5, Color3.fromRGB(90, 30, 160)),  -- ungu medium
                ColorSequenceKeypoint.new(1,   Color3.fromRGB(160, 60, 255)), -- ungu muda neon
            }
            grad.Rotation = 135
            grad.Parent = m
