...
function TabContent.createUI(config, state, version, isMobile, featureModule, getKeyName, gameName)
    ...
    local function Se1()
        ...
        Txt("Welcome!", "RoBeats Autoplayer")
    ...
    local function Se2()
        ...
        La("Autoplayer Features")
        
        Tg("Autoplayer Perfect+S", "Autoplayer", function(v)
            Feature.toggleAutoplayer(v)
        end, "113924612849076")
        
        Txt("Info", "Auto hits Perfect notes")
        Txt("Credits", "Made by tenaakii")
