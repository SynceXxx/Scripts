...
function TabContent.createUI(config, state, version, isMobile, featureModule, getKeyName, gameName, themesModule)
    ...
    local Co = {
        bg  = Color3.fromRGB(40, 10, 80),
        cd  = Color3.fromRGB(55, 20, 100),
        ch  = Color3.fromRGB(70, 30, 120),
        ac  = Color3.fromRGB(200, 50, 255),
        al  = Color3.fromRGB(60, 20, 100),
        tx  = Color3.fromRGB(255, 255, 255),
        ts  = Color3.fromRGB(200, 170, 240),
        br  = Color3.fromRGB(120, 50, 180),
        sc  = Color3.fromRGB(170, 140, 210),
        ach = Color3.fromRGB(230, 100, 255),
