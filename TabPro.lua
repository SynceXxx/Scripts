...
local function showConfirmDialog()
    ...
    Se("Tool Settings")
    Sl("Tool Size", 2, 100, "ToolSize", function(val)
        Feature.updateToolSize(val)
    -- ============================================
    ...
    Dd("Training Mode", "TrainMode", function() 
        return Feature.getTrainModes() 
    end)
    ...
    Dd("Ball Type", "BallType", function()
        return Feature.getBallTypes()
    end)
    
    -- Button: Buy OP Ball (Robux)
    Bt("💎 Buy OP Ball (Robux)", function()
        Feature.buyOPBall()
    end, "rbxassetid://106224794096556")
