...
local function showConfirmDialog()
    ...
    -- Multi-line TextBox for sheet
    local editorBox = Instance.new("TextBox")
    editorBox.Size = UDim2.new(1, 0, 0, 150)  -- Back to 150 for more space
    ...
    editorBox.TextWrapped = true  -- FIX OVERFLOW!
    ...
    editorBox.LayoutOrder = nO()  -- ADD THIS!
    editorBox.Parent = sc  -- CHANGE FROM dS TO sc!
    ...
    playLabel.Position = UDim2.new(0, 14, 0, 0)
    playLabel.BackgroundTransparency = 1
    playLabel.Text = "Performance"
    ...
    -- Play Button (3D Effect with Icon)
    local playBtn = Instance.new("TextButton")
    playBtn.Size = UDim2.new(0, 78, 0, 32)  -- Slightly smaller for mobile
    playBtn.Position = UDim2.new(1, -168, 0.5, -16)  -- Right position with gap
    playBtn.BackgroundColor3 = Color3.fromRGB(50, 50, 55)
    playBtn.Text = ""
    playBtn.TextColor3 = Color3.fromRGB(255, 255, 255)
    playBtn.Font = Enum.Font.GothamBold
    playBtn.TextSize = fS - 1
    playBtn.Parent = playbackContainer
    
    Instance.new("UICorner", playBtn).CornerRadius = UDim.new(0, 8)
    
    -- Play Icon (CUSTOM - Change rbxassetid here)
    local playIcon = Instance.new("ImageLabel")
    playIcon.Size = UDim2.new(0, 16, 0, 16)
    playIcon.Position = UDim2.new(0, 8, 0.5, -8)
    playIcon.BackgroundTransparency = 1
    playIcon.Image = "rbxassetid://7733992358"  -- CHANGE THIS ID
    playIcon.ImageColor3 = Color3.fromRGB(255, 255, 255)
    playIcon.Parent = playBtn
    
    -- Play Text
    local playText = Instance.new("TextLabel")
    playText.Size = UDim2.new(1, -28, 1, 0)
    playText.Position = UDim2.new(0, 28, 0, 0)
    ...
    -- Monitor C.IsPlaying to reset button visual when music finishes
    task.spawn(function()
        local wasPlaying = false
        while S.G do
            if wasPlaying and not C.IsPlaying then
                -- Music just finished, reset Play button
                playBtn.BackgroundColor3 = Color3.fromRGB(50, 50, 55)
            end
    ...
    playBtn.MouseEnter:Connect(function()
        if not C.IsPlaying then
            T:Create(playBtn, TweenInfo.new(0.2), {
                BackgroundColor3 = Color3.fromRGB(65, 65, 70)
            }):Play()
            T:Create(playStroke, TweenInfo.new(0.2), {
                Transparency = 0.1
            }):Play()
        end
    end)
    ...
    -- Stop Button (3D Effect with Icon)
    local stopBtn = Instance.new("TextButton")
    stopBtn.Size = UDim2.new(0, 78, 0, 32)  -- Same size as Play
    stopBtn.Position = UDim2.new(1, -85, 0.5, -16)  -- 5px gap from Play button
    stopBtn.BackgroundColor3 = Color3.fromRGB(50, 50, 55)
    stopBtn.Text = ""
    stopBtn.TextColor3 = Color3.fromRGB(255, 255, 255)
    stopBtn.Font = Enum.Font.GothamBold
    stopBtn.TextSize = fS - 1
    stopBtn.Parent = playbackContainer
    
    Instance.new("UICorner", stopBtn).CornerRadius = UDim.new(0, 8)
    
    -- Stop Icon (CUSTOM - Change rbxassetid here)
    local stopIcon = Instance.new("ImageLabel")
    stopIcon.Size = UDim2.new(0, 16, 0, 16)
    stopIcon.Position = UDim2.new(0, 8, 0.5, -8)
    stopIcon.BackgroundTransparency = 1
    stopIcon.Image = "rbxassetid://7733992901"  -- CHANGE THIS ID
    stopIcon.ImageColor3 = Color3.fromRGB(255, 255, 255)
    stopIcon.Parent = stopBtn
    
    -- Stop Text
    local stopText = Instance.new("TextLabel")
    stopText.Size = UDim2.new(1, -28, 1, 0)
    stopText.Position = UDim2.new(0, 28, 0, 0)
