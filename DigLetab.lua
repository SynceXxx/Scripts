...
local function showConfirmDialog()
    ...
    -- Build UI content for Dig Legends
    Se("Auto Farm")
    
    -- Auto Trophy Toggle
    Tg("Auto Trophy", "AutoTrophy", function(enabled)
        Feature.toggleAutoTrophy(enabled)
    end, "121640601863855")
    
    -- Auto Rewards Toggle
    Tg("Auto Rewards", "AutoRewards", function(enabled)
        Feature.toggleAutoRewards(enabled)
    end, "85752972683600")
