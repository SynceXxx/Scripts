...
local function showConfirmDialog()
    ...
    -- Multi-line TextBox for sheet (CLEAN STYLE)
    ...
    editorBox.PlaceholderColor3 = Co.ts  -- ✅ Same color as library
    editorBox.MultiLine = true
    editorBox.TextWrapped = true
    editorBox.TextColor3 = Co.tx
    editorBox.Font = Enum.Font.GothamMedium  -- ✅ Same font as library
    editorBox.TextSize = fS  -- ✅ Same size as library
    editorBox.TextXAlignment = Enum.TextXAlignment.Left  -- ✅ Back to left (original)
    editorBox.TextYAlignment = Enum.TextYAlignment.Top   -- ✅ Back to top (original)
