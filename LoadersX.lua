...
-- Border glow dengan spinning gradient
...
local function fadeInAll()
    ...
    -- Progress bar muncul duluan & cepet
    tw(barBackground, {BackgroundTransparency = 0}, 0.2):Play()
    tw(barFill, {BackgroundTransparency = 0}, 0.2):Play()
    tw(percentLabel, {TextTransparency = 0}, 0.2):Play()
    tw(versionLabel, {TextTransparency = 0}, 0.2):Play()
    tw(statusLabel, {TextTransparency = 0}, 0.2):Play()

    -- Avatar & nama muncul cepet barengan bar
    task.wait(0.1)
    tw(avatarStroke, {Transparency = 0}, 0.2):Play()
    tw(avatarImg, {ImageTransparency = 0}, 0.2):Play()
    tw(nameLabel, {TextTransparency = 0}, 0.2):Play()

    -- Typing jalan paralel
    task.wait(0.15)
    task.spawn(function()
