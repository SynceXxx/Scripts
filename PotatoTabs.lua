...
local function showConfirmDialog()
    ...
    local function applyTheme(theme)
        ...
        local function updateElement(element)
            ...
            pcall(function()
                ...
                elseif element:IsA("TextButton") then
                    -- Skip header buttons
                    if element.Text == "×" or element.Text == "−" or element.Text == "+" then return end
                    ...
                    if isToggle then
                        -- FIX 3: deteksi ON pakai oldCo.ac, bukan hardcode biru
        ...
        -- FIX 4: Success sound pakai delay yang sama kayak error (task.wait kecil sebelum play)
        task.spawn(function()
            task.wait(0.05)
