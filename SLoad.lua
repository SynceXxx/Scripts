...
function loader:Remove()
    ...
    -- Semua isi hilang SEKETIKA duluan
    avatarImg.ImageTransparency = 1
    avatarStroke.Transparency = 1
    containerStroke.Transparency = 1
    nameLabel.TextTransparency = 1
    ...
    -- Baru container slide turun + fade kosong
    tw(container, {
        Position = UDim2.new(0.5, -CONFIG.ContainerWidth / 2, 0.5, -CONFIG.ContainerHeight / 2 + 60),
        BackgroundTransparency = 1
    }, t * 1.5, Enum.EasingStyle.Quad, Enum.EasingDirection.In):Play()
