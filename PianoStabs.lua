...
local function showConfirmDialog()
    ...
    playBtn.Size = UDim2.new(0, 80, 0, 32)
    playBtn.Position = UDim2.new(1, -165, 0.5, -16)
    ...
    stopBtn.Position = UDim2.new(1, -80, 0.5, -16)
    ...
    local function refreshSongList()
        ...
        if #songs == 0 then
            ...
            for i, song in ipairs(songs) do
                ...
                loadBtn.Position = UDim2.new(1, -120, 0.5, -15)
                ...
                delBtn.Size = UDim2.new(0, 55, 0, 30)
