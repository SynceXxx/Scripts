...
-- Pre-load sounds
local sndOpen    = createSound("3091126045", 0.4, 1.0)   -- electronic/sci-fi boot
local sndClose   = createSound("4590662766", 0.5, 0.9)   -- close sound (pitch rendah, beda dari ready)
local sndTick    = createSound("6895079853", 0.35, 1.8)  -- tick tiap progress
