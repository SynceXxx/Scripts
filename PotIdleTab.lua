...
function TabContent.createUI(config, state, version, isMobile, featureModule, getKeyName, gameName, themesModule, sidebarModule)
    ...
    -- ============================================
    -- SINGLE SCROLL FRAME (tab system dihapus)
    -- ============================================
    ...
    local function useTab(_idx)
        -- Tab dihapus, semua content masuk ke sc
        currentOrd = 0
    end
    ...
    local function showHub()
        ...
        m.Position = UDim2.new(0, vp.X + 50, 0, mFinalAbsY)
        m.Visible  = true
    ...
    m.Position = UDim2.new(0, vp0.X + 50, 0, mFinalAbsY)
    m.Visible  = true
