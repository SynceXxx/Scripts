...
Themes.List = {
    ...
    },
    {
        ...
        ID = "neon_purple",
        Colors = {
            bg  = Color3.fromRGB(8, 5, 20),     -- hitam ungu gelap (sama kayak loader)
            cd  = Color3.fromRGB(15, 8, 35),
            ch  = Color3.fromRGB(25, 10, 45),
            br  = Color3.fromRGB(55, 15, 80),    -- ungu gradient loader
            tx  = Color3.fromRGB(255, 255, 255),
            ts  = Color3.fromRGB(180, 150, 220),
            ac  = Color3.fromRGB(200, 50, 255),  -- ungu neon accent
            ach = Color3.fromRGB(230, 100, 255), -- ungu neon lebih terang
