...
function loader:Remove()
    ...
    -- Container slide turun sambil fade
    tw(container, {
        Position = UDim2.new(0.5, -CONFIG.ContainerWidth / 2, 0.5, -CONFIG.ContainerHeight / 2 + 70),
        BackgroundTransparency = 1
    }, t, Enum.EasingStyle.Quad, Enum.EasingDirection.In):Play()
    tw(containerStroke, {Transparency = 1}, t):Play()
