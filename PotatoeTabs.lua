...
local function showConfirmDialog()
    ...
    local function applyTheme(theme)
        ...
        -- Update Co ke warna baru (untuk elemen yang dibuat setelah ini)
        Co.bg  = colors.bg
        Co.cd  = colors.cd
        Co.ch  = colors.ch
        Co.br  = colors.br
