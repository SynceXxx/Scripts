...
local function showConfirmDialog()
    ...
    editorBox.PlaceholderText = "Paste piano sheet here...\nExample: qwe-rty | [qaz] (wsx)"
    editorBox.MultiLine = true
    editorBox.TextWrapped = true
    editorBox.TextColor3 = Co.tx
    editorBox.Font = Enum.Font.GothamMedium
    editorBox.TextSize = fS - 1
    ...
    Sl("BPM Control", "BPM", 50, 300, nil, "75435158430538")
    ...
    perfIcon.Image = "rbxassetid://81768506951850"  -- Icon piano
    ...
    playIcon.Image = "rbxassetid://7733919731"  -- Play icon
    ...
    stopIcon.Image = "rbxassetid://7733919620"  -- Stop icon
    ...
    local function refreshSongList()
        ...
        if #songs == 0 then
            ...
            for i, song in ipairs(songs) do
                ...
                -- Load button (DARK THEME with 3D Effect and Icon)
                local loadBtn = Instance.new("TextButton")
                loadBtn.Size = UDim2.new(0, 58, 0, 30)  -- Slightly smaller
                loadBtn.Position = UDim2.new(1, -123, 0.5, -15)  -- Precise position
                loadBtn.BackgroundColor3 = Color3.fromRGB(50, 50, 55)  -- Dark grey
                loadBtn.Text = ""
                loadBtn.TextColor3 = Color3.fromRGB(255, 255, 255)
                loadBtn.Font = Enum.Font.GothamBold
                loadBtn.TextSize = fS - 1
                loadBtn.Parent = songItem
                
                Instance.new("UICorner", loadBtn).CornerRadius = UDim.new(0, 8)
                
                -- Load Icon (CUSTOM - Change rbxassetid here)
                local loadIcon = Instance.new("ImageLabel")
                loadIcon.Size = UDim2.new(0, 14, 0, 14)
                loadIcon.Position = UDim2.new(0, 6, 0.5, -7)
                loadIcon.BackgroundTransparency = 1
                loadIcon.Image = "rbxassetid://7733674079"  -- CHANGE THIS ID
                loadIcon.ImageColor3 = Color3.fromRGB(255, 255, 255)
                loadIcon.Parent = loadBtn
                
                -- Load Text
                local loadText = Instance.new("TextLabel")
                loadText.Size = UDim2.new(1, -24, 1, 0)
                loadText.Position = UDim2.new(0, 24, 0, 0)
                loadText.BackgroundTransparency = 1
                loadText.Text = "Load"
                loadText.TextColor3 = Color3.fromRGB(255, 255, 255)
                loadText.Font = Enum.Font.GothamBold
                loadText.TextSize = fS - 2
                loadText.TextXAlignment = Enum.TextXAlignment.Left
                loadText.Parent = loadBtn
                
                -- 3D Effect
                local loadStroke = Instance.new("UIStroke", loadBtn)
                loadStroke.Color = Color3.fromRGB(80, 80, 90)
                ...
                loadBtn.MouseEnter:Connect(function()
                    T:Create(loadBtn, TweenInfo.new(0.2), {
                        BackgroundColor3 = Color3.fromRGB(65, 65, 70)  -- Dark grey hover
                    }):Play()
                    T:Create(loadStroke, TweenInfo.new(0.2), {
                        Transparency = 0.1  -- More visible on hover
                    }):Play()
                end)
                
                loadBtn.MouseLeave:Connect(function()
                    T:Create(loadBtn, TweenInfo.new(0.2), {
                        BackgroundColor3 = Color3.fromRGB(50, 50, 55)  -- Back to dark grey
                    }):Play()
                    T:Create(loadStroke, TweenInfo.new(0.2), {
                        Transparency = 0.3  -- Back to subtle
                    }):Play()
                end)
                
                -- Delete button (DARK THEME with 3D Effect and Icon)
                local delBtn = Instance.new("TextButton")
                delBtn.Size = UDim2.new(0, 53, 0, 30)  -- Same height as Load
                delBtn.Position = UDim2.new(1, -60, 0.5, -15)  -- 5px gap from Load
                delBtn.BackgroundColor3 = Color3.fromRGB(50, 50, 55)  -- Same dark grey
                delBtn.Text = ""
                delBtn.TextColor3 = Color3.fromRGB(255, 255, 255)
                delBtn.Font = Enum.Font.GothamBold
                delBtn.TextSize = fS - 1
                delBtn.Parent = songItem
                
                Instance.new("UICorner", delBtn).CornerRadius = UDim.new(0, 8)
                
                -- Delete Icon (CUSTOM - Change rbxassetid here)
                local delIcon = Instance.new("ImageLabel")
                delIcon.Size = UDim2.new(0, 14, 0, 14)
                delIcon.Position = UDim2.new(0, 5, 0.5, -7)
                delIcon.BackgroundTransparency = 1
                delIcon.Image = "rbxassetid://7733717447"  -- CHANGE THIS ID
                delIcon.ImageColor3 = Color3.fromRGB(255, 255, 255)
                delIcon.Parent = delBtn
                
                -- Delete Text
                local delText = Instance.new("TextLabel")
                delText.Size = UDim2.new(1, -22, 1, 0)
                delText.Position = UDim2.new(0, 22, 0, 0)
                delText.BackgroundTransparency = 1
                delText.Text = "Del"
                delText.TextColor3 = Color3.fromRGB(255, 255, 255)
                delText.Font = Enum.Font.GothamBold
                delText.TextSize = fS - 2
                delText.TextXAlignment = Enum.TextXAlignment.Left
                delText.Parent = delBtn
                
                -- 3D Effect with red hint
                local delStroke = Instance.new("UIStroke", delBtn)
                delStroke.Color = Color3.fromRGB(90, 70, 75)  -- Subtle red tint
                ...
                delBtn.MouseEnter:Connect(function()
                    T:Create(delBtn, TweenInfo.new(0.2), {
                        BackgroundColor3 = Color3.fromRGB(70, 50, 55)  -- Dark with red hint
                    }):Play()
                    T:Create(delStroke, TweenInfo.new(0.2), {
                        Transparency = 0.1  -- More visible on hover
                    }):Play()
                end)
    ...
    end, "rbxassetid://112391267091944")
