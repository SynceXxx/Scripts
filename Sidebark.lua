...
-- Sidebar adalah child dari Main Frame (m), posisi relatif otomatis ikut
...
-- ============================================
-- CREATE SIDEBAR
-- Sidebar di-parent ke m (Main Frame) supaya
-- otomatis ikut posisi, animasi, dan visibility m
-- ============================================
function Sidebar.create(g, m, Co, onTabSwitch)
    ...
    -- ============================================
    -- SIDEBAR PANEL
    -- Parent = m, posisi di sebelah kiri m (offset negatif)
    -- ============================================
    local sidebar = Instance.new("Frame")
    sidebar.Name             = "Sidebar"
    -- Lebar SB_W, tinggi = m dikurangi offset atas+bawah
    sidebar.Size             = UDim2.new(0, SB_W, 1, -(SB_Y_OFFSET * 2))
    -- Posisi: di luar kiri m (X negatif), offset Y ke bawah sedikit
    sidebar.Position         = UDim2.new(0, -(SB_W + SB_GAP), 0, SB_Y_OFFSET)
    sidebar.BackgroundColor3 = Co.bg
    sidebar.BorderSizePixel  = 0
    sidebar.ZIndex           = 1
    sidebar:SetAttribute("ThemeTag", "bg")
    -- Parent ke m bukan g — ini kuncinya!
    sidebar.Parent           = m
    ...
    -- ============================================
    -- syncPositions — tidak perlu hitung apapun,
    -- sidebar sudah otomatis ikut m
    -- Fungsi ini dipertahankan sebagai stub supaya
    -- tidak error kalau dipanggil dari Lop.lua
    -- ============================================
    local function syncPositions() end
