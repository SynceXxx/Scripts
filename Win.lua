...
function TabContent.createUI(config, state, version, isMobile, featureModule, getKeyName, gameName, themesModule, sidebarModule)
    ...
    local function applyTheme(theme)
        ...
        sb.pillLabel.TextColor3 = colors.ts
    ...
    themeBtn.MouseButton1Click:Connect(function()
        ...
        playSound(Sounds.Click, 0.3)
        currentThemeIndex = currentThemeIndex % #themesModule.List + 1
    ...
    local function Ds(text, isWarning)
        ...
        d.Size=UDim2.new(1,-8,0,0); d.BackgroundTransparency=1
        d.Text=text; d.TextColor3=isWarning and Color3.fromRGB(255,200,100) or Co.ts
        d.Font=Enum.Font.GothamMedium; d.TextSize=11
        d.TextXAlignment=Enum.TextXAlignment.Left; d.TextWrapped=true
        d.TextYAlignment=Enum.TextYAlignment.Top
        d.LayoutOrder=nO(); d.AutomaticSize=Enum.AutomaticSize.Y; d.Parent=currentSc
        local pad=Instance.new("UIPadding",d)
    ...
    -- ============================================
    -- CONTENT: TAB 3 — VISUAL
    -- ============================================
    useTab(3)

    Se("VISUAL")
    Ds("Visual features coming soon.")
