...
local tabDefs = {
    { name = "Home",     icon = "rbxassetid://92534286955016"   },
    { name = "Player",   icon = "rbxassetid://118025272389341"  },
    { name = "Visual",   icon = "rbxassetid://133293821242097"  },
...
function Sidebar.create(g, m, Co, onTabSwitch)
    ...
    -- ============================================
    -- PILL ANIMASI MUNCUL (dari balik main frame)
    -- ============================================
    ...
    -- PILL ANIMASI SEMBUNYI (masuk ke balik main frame)
