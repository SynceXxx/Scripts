...
local function showConfirmDialog()
    ...
    Se("BPM Control", "75435158430538")  -- Icon speedometer untuk BPM Control
    
    -- BPM Input
    Ib("BPM", "BPM")
    
    Se("Become a pianist", "81768506951850")  -- Icon piano untuk Become a pianist
    ...
    -- Icon untuk Performance section
    ...
    stopText.TextXAlignment = Enum.TextXAlignment.Center
