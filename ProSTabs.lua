...
local function showConfirmDialog()
    ...
    -- Toggle: Auto Collect Energy
    Tg("Auto Collect Energy", "AutoCollectEnergy", function(v)
        Feature.toggleAutoCollectEnergy(v)
    end)
    
    -- Button: Rejoin Server
    Bt("Rejoin Server (if bug)", function()
        Feature.rejoinServer()
    end, "rbxassetid://133510707368125")
    
    -- Warning description
    Ds("⚠️ Warning: This feature may have bugs and could cause performance issues.", true)
