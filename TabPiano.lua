    ...
    local function refreshSongList()
        ...
        if #songs == 0 then
            ...
            for i, song in ipairs(songs) do
                ...
                loadBtn.BackgroundColor3 = Co.ac
                loadBtn.Text = "Load"
                ...
                loadBtn.MouseButton1Click:Connect(function()
                    playSound(Sounds.Click, 0.4)
                    local sheet = Feature.loadSong(i)
                    if sheet then
                        ...
                        Feature.showNotification("Loaded: " .. song.Name, true)
                    end
                end)
