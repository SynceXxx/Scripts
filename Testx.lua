...
local function showConfirmDialog()
    ...
    cb.MouseButton1Click:Connect(function()
        ...
        cb.Text = mn and "+" or "−"
        -- Saat minimize, tutup sidebar
        if mn then
            sidebarOpen = false
            T:Create(sidebar, TweenInfo.new(0.2), {Position = UDim2.new(0, closedX, 0, 0)}):Play()
    ...
    -- ============================================
    -- SIDEBAR + TOGGLE
    -- toggleBtn = child of m, FIXED di kiri hub, tidak ikut slide
    -- sidebar = child of m, slide kiri/kanan di belakang toggleBtn
    -- ============================================
    local sidebarW    = 52
    local toggleW     = 18
    local toggleH     = 60
    ...
    -- toggleBtn: child of m, posisi fix di kiri luar hub
    -- Tidak bergerak sama sekali
    local toggleBtn = Instance.new("TextButton")
    toggleBtn.Name = "SidebarToggle"
    toggleBtn.Size = UDim2.new(0, toggleW, 0, toggleH)
    toggleBtn.AnchorPoint = Vector2.new(1, 0.5)
    toggleBtn.Position = UDim2.new(0, -4, 0.5, 0)  -- fix di kiri hub, tengah vertikal
    toggleBtn.BackgroundColor3 = Co.cd
    toggleBtn.Text = ""
    toggleBtn.ZIndex = 4  -- di depan sidebar
    ...
    -- sidebar: child of m, slide kiri/kanan
    -- Saat tertutup: x = -4 (tersembunyi di balik toggleBtn)
    -- Saat terbuka:  x = -(sidebarW + toggleW + 4)
    local closedX = -4
    local openX   = -(sidebarW + toggleW + 6)
    ...
    sidebar.ZIndex = 2  -- di belakang toggleBtn
    ...
    -- Buka/tutup sidebar — toggleBtn diam, sidebar yang slide
        ...
        mT.InputEnded:Connect(function(input)
            if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
                ...
                if not wasDragged then
                    ...
                    -- Saat hub di-hide, tutup sidebar juga
